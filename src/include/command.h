...
static const command_t commands[] =
{
    ...
    {eCOMMAND_SCIENTIFIC, "scientific", "-s", "Set the display mode (normal or scientific)",
        {"Use:",
         "  Set to normal: -s" + parameterSign + "0 | --scientific" + parameterSign + "0",
         "  Set to scientific: -s" + parameterSign + "1 | --scientific" + parameterSign + "1"}},
